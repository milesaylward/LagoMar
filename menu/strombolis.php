        <?php $title="Lago Mar | Strombolis & Calzones" ?>
        ...
        <div id="menu" class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12">
          ...
          <section class="menu-item">
            <h2 class="item-header">Stromboli</h2>
            <h4 class="ingredients">
              Mozzarella Cheese &amp; your choice of 4 pizza toppings
            </h4>
          ...
          <section class="menu-item">
            <h2 class="item-header">Extra Filling</h2>
            <div class="text-center">
              <h3 class="price">1.29</h3>
            </div>
          </section>
          <section class="menu-item">
            <h2 class="item-header">Extra Marinara Sauce</h2>
            <div class="text-center">
